...
function StickyOverlay(props) {
  ...
  var regions = ref.current ? regionsWithComputedRects(reportedValues, ref.current) : [];
  ...
  var renderCallback = _react.default.useCallback((regionsWithIntersectionDetails, containerWidth) => {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, [renderDock('top', margins, grouped.top, counts.nearTop), /*#__PURE__*/_react.default.createElement(Spacer, {
      key: "spacerTop",
      height: topSpacing
    }), ...renderInside(grouped.inside, containerWidth), /*#__PURE__*/_react.default.createElement(Spacer, {
      key: "spacerBottom",
...
function renderDock(position, margins, regionsWithIntersectionDetails, closeCount) {
  ...
  var allPresenceItems = (0, _flatten2.default)((0, _sortBy2.default)(regionsWithIntersectionDetails, r => r.region.rect.top * dir).map(withIntersection => withIntersection.region.presence || []) || []);
