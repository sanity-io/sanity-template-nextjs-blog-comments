...
export declare class DocumentBuilder implements Serializable {
    ...
    getChild(): DocumentNode | DocumentBuilder | import("./List").List | import("./DocumentList").DocumentList | EditorNode | import("./Component").Component | import("./List").ListBuilder | import("./DocumentList").DocumentListBuilder | import("./DocumentTypeList").DocumentTypeListBuilder | import("./Component").ComponentBuilder | import("./ChildResolver").ChildResolver | undefined;
