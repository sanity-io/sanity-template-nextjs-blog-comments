...
export declare abstract class GenericListBuilder<L extends BuildableGenericList, ConcreteImpl> implements Serializable {
    ...
    getChild(): import("./StructureNodes").DocumentNode | import("./Document").DocumentBuilder | import("./List").List | import("./DocumentList").DocumentList | import("./StructureNodes").EditorNode | import("./Component").Component | import("./List").ListBuilder | import("./DocumentList").DocumentListBuilder | import("./DocumentTypeList").DocumentTypeListBuilder | import("./Component").ComponentBuilder | import("./ChildResolver").ChildResolver | undefined;
