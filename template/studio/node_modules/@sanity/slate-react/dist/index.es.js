...
var setReverseDomSelection = (domRange, domSelection) => {
  ...
  domSelection.setBaseAndExtent(newRange.startContainer, newRange.startOffset, newRange.endContainer, newRange.endOffset); // moves the focus of the selection to domRange's anchor
