...
export declare class Timeline {
    ...
    calculateDiff(initialDoc: CombinedDocument, finalDoc: CombinedDocument, firstIdx: number, lastIdx: number): import("@sanity/field/diff").Diff<unknown, Record<string, any>>;
}
export {};
