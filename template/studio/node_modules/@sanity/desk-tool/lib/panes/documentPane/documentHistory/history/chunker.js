...
function chunkFromTransaction(transaction) {
  var modifedDraft = transaction.draftEffect != null;
  var modifedPublished = transaction.publishedEffect != null;
  var draftDeleted = modifedDraft && isDeletePatch(transaction.draftEffect.apply);
  var publishedDeleted = modifedPublished && isDeletePatch(transaction.publishedEffect.apply);
  var type = 'editDraft';
