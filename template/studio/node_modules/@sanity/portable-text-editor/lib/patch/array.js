...
const arrayInsert_1 = __importDefault(require("./arrayInsert"));
...
function findTargetIndex(array, pathSegment) {
    ...
    const index = lodash_1.findIndex(array, pathSegment);
...
function apply(value, patch) {
    ...
    if (tail.length === 0) {
        if (patch.type === 'insert') {
            ...
            return arrayInsert_1.default(value, position, index, items);
        }
        else if (patch.type === 'unset') {
    ...
    nextValue[index] = applyPatch_1.default(nextValue[index], Object.assign(Object.assign({}, patch), { path: tail }));
    return nextValue;
}
