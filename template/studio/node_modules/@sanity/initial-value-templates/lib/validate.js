...
exports.validateInitialValue = validateInitialValue;
...
function validateInitialValue(value, template) {
  ...
  if (value._type && template.schemaType !== value._type) {
    throw new Error(contextError((0, _oneline.default)(_templateObject(), value._type, template.schemaType)));
  }
...
function validateValue(value) {
  ...
  if (path.length > 0 && !value._type) {
    if (value._ref) {
      ...
      throw new Error("missing \"_type\" property at path \"".concat((0, _paths.toString)(path), "\""));
    }
  }
