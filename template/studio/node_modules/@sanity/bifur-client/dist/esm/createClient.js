...
var getNextRequestId = customAlphabet('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-', 20);
var HEARTBEAT = '♥';
...
var finalizeWith = function (finalizer$) { return function (input$) {
    return input$.pipe(finalize(function () { return finalizer$.pipe(catchError(function () { return EMPTY; })).subscribe(); }));
}; };
export var createClient = function (connection$) {
    ...
    function requestSubscribe(method, params) {
        return call(method + "_subscribe", params).pipe(take(1), mergeMap(function (subscriptionId) {
            ...
            }), map(function (message) { return message.params.result; }), finalizeWith(call(method + "_unsubscribe", { subscriptionId: subscriptionId })));
        }));
    }
    return {
