  ...
  return _temp = _class = class ButtonLike extends _react.default.Component {
    ...
    render() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["kind", "inverted", "color", "icon", "iconStatus", "loading", "className", "children", "disabled", "padding", "bleed", "selected", "size", "tone"]);
