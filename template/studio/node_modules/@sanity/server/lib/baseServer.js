...
var getDocumentComponent = basePath => (0, _resolver.resolveParts)({
  basePath
}).then(res => {
...
function getDocumentElement(_ref) {
  ...
  return getDocumentComponent(basePath).then(Document => /*#__PURE__*/_react.default.createElement(Document, Object.assign({
    // URL base path
