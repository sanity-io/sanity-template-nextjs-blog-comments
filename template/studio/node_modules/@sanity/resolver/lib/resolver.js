...
function getImplementationDeclaration(plugin, part, options) {
  ...
  var isLib = options.useCompiledPaths || plugin.path.split(_path.default.sep).indexOf('node_modules') !== -1;
  var isDotPath = /^\.{1,2}[\\/]/.test(part.path);
  var basePath = isDotPath ? plugin.path : _path.default.join(plugin.path, (isLib ? paths.compiled : paths.source) || '');
