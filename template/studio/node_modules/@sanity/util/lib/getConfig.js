...
var getConfig = function getConfig(rootDir) {
  ...
  var config = (0, _reduceConfig.default)(localConfig ? (0, _merge2.default)({}, defaults, localConfig) : defaults, options.env || process.env.NODE_ENV || 'development', // eslint-disable-line no-process-env
  {
