...
function getReferencedType(referenceType) {
  if (!referenceType.to) {
    return referenceType.type ? getReferencedType(referenceType.type) : undefined;
  }
  ...
  var targetType = _schema.default.get(referenceType.to[0].name);
