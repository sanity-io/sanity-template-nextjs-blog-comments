...
var ArrayOfOptionsFieldDiff = (_ref) => {
  ...
  var options = (_schemaType$options = schemaType.options) === null || _schemaType$options === void 0 ? void 0 : _schemaType$options.list;
...
function getOptionIndex(item, schemaType) {
  ...
  var list = ((_schemaType$options2 = schemaType.options) === null || _schemaType$options2 === void 0 ? void 0 : _schemaType$options2.list) || [];
...
function getItemTitle(item, schemaType) {
  ...
  var list = ((_schemaType$options3 = schemaType.options) === null || _schemaType$options3 === void 0 ? void 0 : _schemaType$options3.list) || [];
