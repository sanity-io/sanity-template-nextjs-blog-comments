...
function HotspotCropSVG(props) {
  var crop = props.crop,
      ...
      restProps = _objectWithoutProperties(props, ["crop", "diff", "hash", "hotspot", "width", "height"]);
...
function CropSVG(_ref) {
  var crop = _ref.crop,
      width = _ref.width,
      height = _ref.height,
      restProps = _objectWithoutProperties(_ref, ["crop", "width", "height"]);
...
function HotspotSVG(_ref2) {
  var hotspot = _ref2.hotspot,
      ...
      width = _ref2.width,
      height = _ref2.height,
      restProps = _objectWithoutProperties(_ref2, ["hotspot", "offset", "width", "height"]);
