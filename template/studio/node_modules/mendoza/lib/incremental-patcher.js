  ...
  updateEndMeta(content) {
    if (content.type == 'string') {
      ...
      if (content.type === 'array') {
        ...
        for (var _i2 = 0, _Object$values = Object.values(content.fields); _i2 < _Object$values.length; _i2++) {
    ...
    case 'object':
      {
        ...
        for (var _i3 = 0, _Object$entries2 = Object.entries(content.fields); _i3 < _Object$entries2.length; _i3++) {
    ...
    case 'object':
      {
        ...
        for (var _i4 = 0, _Object$entries3 = Object.entries(rightObj.fields); _i4 < _Object$entries3.length; _i4++) {
